# Generated by Django 4.2 on 2023-10-27 12:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(default='user@alt.com', max_length=50, verbose_name='Email')),
                ('note', models.CharField(default='No Note', max_length=50, verbose_name='Note')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('', ''), ('Pending', 'Pending'), ('Done', 'Done'), ('Delivered', 'Delivered')], default=('', ''), max_length=50, verbose_name='Status')),
                ('client', models.CharField(choices=[('', ''), ('End_User', 'End_User'), ('Vendor', 'Vendor')], default=('', ''), max_length=50, verbose_name='client')),
                ...
                ('note', models.CharField(default='No Note', max_length=50, verbose_name='Note')),
                ('End_User', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Request_client', to='Technical.end_user', verbose_name='Client')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detail', models.TextField(default='Write Issue Detail', max_length=500, verbose_name='Detail')),
                ('note', models.CharField(default='No Note', max_length=50, verbose_name='Note')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('serial', models.CharField(max_length=50, verbose_name='S.N')),
                ('detail', models.TextField(default='Write Action Detail', max_length=500, verbose_name='Detail')),
